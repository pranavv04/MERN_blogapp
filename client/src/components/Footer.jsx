  ...
  return (
    <div className='bg-black text-white flex justify-around items-center text-sm w-full py-6'>
      ...
      <div className='flex items-center'>
        ...
        <a href="https://www.linkedin.com/in/pranav-dhangar-26b67a220/" target='__blank'><FaLinkedin className='text-2xl mr-2 cursor-pointer' /></a>
        <a href="https://github.com/pranavv04" target='__blank'><FaGithub className='text-2xl mr-2 cursor-pointer' /></a>
        <a href="https://x.com/_pranavv04_" target='__blank'>  <FaXTwitter   className='text-2xl mr-2 cursor-pointer' /></a>
        <a href={`mailto: ${mails}`}>  <CiMail className='text-2xl mr-2 cursor-pointer' /></a>
